...
├── shoe_demo.py                       # Shoe product content generator demo
└── templates/
    ...
    └── shoe_product.md                # Shoe product content template
```
...
Generates a complete 10-section production package and exports a JSON sample to
`movie_engine_output.json`.
...
Generates AI-powered product packages (descriptions, marketing copy, SEO keywords,
pricing strategy) for shoe products.
